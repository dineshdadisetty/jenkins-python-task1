pipeline {
    ...
    stages {
        stage('Cloning Git') {
            steps {
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'dineshdadisetty', url: 'https://github.com/dineshdadisetty/jenkins-python-task1.git']])       
            }
        }
